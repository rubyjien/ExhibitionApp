...
<form action="CustModiProc.jsp">
<table class="table table-striped table-condensed" method="post" >
   <tr>
      <th>아이디</th>
      <td>
      <input type="text" class="form-control" value="<%=rscustid %>" name="custid" disabled/>
